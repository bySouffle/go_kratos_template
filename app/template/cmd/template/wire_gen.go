...
func wireApp(appInfo *conf.APPInfo, confServer *conf.Server, confData *conf.Data, logger log.Logger, tracerProvider *trace.TracerProvider, registry *conf.Registry, general *conf.General) (*kratos.App, func(), error) {
	...
	httpServer := server.NewHTTPServer(confServer, general, templateService, logger, tracerProvider)
