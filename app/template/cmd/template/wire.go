...
func wireApp(*conf.APPInfo, *conf.Server, *conf.Data, log.Logger, *tracesdk.TracerProvider, *conf.Registry, *conf.General, *conf.Experiment, *conf.Security, *conf.Cron) (*kratos.App, func(), error) {
