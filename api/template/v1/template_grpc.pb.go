...
const (
	Template_CreateTemplate_FullMethodName = "/api.template.v1.Template/CreateTemplate"
	Template_UpdateTemplate_FullMethodName = "/api.template.v1.Template/UpdateTemplate"
	Template_DeleteTemplate_FullMethodName = "/api.template.v1.Template/DeleteTemplate"
	Template_GetTemplate_FullMethodName    = "/api.template.v1.Template/GetTemplate"
	Template_ListTemplate_FullMethodName   = "/api.template.v1.Template/ListTemplate"
	Template_WSTemplate_FullMethodName     = "/api.template.v1.Template/WSTemplate"
)
...
type TemplateClient interface {
	...
	WSTemplate(ctx context.Context, in *WSTemplateRequest, opts ...grpc.CallOption) (*WSTemplateReply, error)
}
...
func (c *templateClient) WSTemplate(ctx context.Context, in *WSTemplateRequest, opts ...grpc.CallOption) (*WSTemplateReply, error) {
	out := new(WSTemplateReply)
	err := c.cc.Invoke(ctx, Template_WSTemplate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTemplateServer) WSTemplate(context.Context, *WSTemplateRequest) (*WSTemplateReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WSTemplate not implemented")
}
...
func _Template_WSTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WSTemplateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TemplateServer).WSTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Template_WSTemplate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemplateServer).WSTemplate(ctx, req.(*WSTemplateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Template_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WSTemplate",
			Handler:    _Template_WSTemplate_Handler,
		},
	},
