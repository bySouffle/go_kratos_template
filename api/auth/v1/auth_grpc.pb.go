...
const (
	Auth_CreateAuth_FullMethodName = "/api.auth.v1.Auth/CreateAuth"
	Auth_UpdateAuth_FullMethodName = "/api.auth.v1.Auth/UpdateAuth"
	Auth_DeleteAuth_FullMethodName = "/api.auth.v1.Auth/DeleteAuth"
	Auth_GetAuth_FullMethodName    = "/api.auth.v1.Auth/GetAuth"
	Auth_ListAuth_FullMethodName   = "/api.auth.v1.Auth/ListAuth"
...
func (c *authClient) CheckAuth(ctx context.Context, in *CheckAuthRequest, opts ...grpc.CallOption) (*CheckAuthReply, error) {
...
func (UnimplementedAuthServer) CheckAuth(context.Context, *CheckAuthRequest) (*CheckAuthReply, error) {
